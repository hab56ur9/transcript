...
- The launcher assembles Transcript.app under the user Applications folder and opens it, so every permission attaches to the app bundle itself — the launch host is irrelevant.
