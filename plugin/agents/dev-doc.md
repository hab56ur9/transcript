...
- When the chosen transcript has a corrected sibling (same base name with the corrected suffix), read the corrected file instead and record it as the document's source transcript.
